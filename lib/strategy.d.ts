...
declare class AdfsStrategy extends Strategy {
    name: string;
    ...
    constructor(options: AdfsStrategy.StrategyOptions, verify: AdfsStrategy.VerifyFunction);
    constructor(options: AdfsStrategy.StrategyOptionsWithRequest, verify: AdfsStrategy.VerifyFunctionWithRequest);
...
declare namespace AdfsStrategy {
    interface Metadata {
    ...
    type Strategy = AdfsStrategy;
    const Strategy: typeof AdfsStrategy;
